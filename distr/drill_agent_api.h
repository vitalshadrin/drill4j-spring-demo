        ...
        struct {
          struct {
            ...
            struct {
              ...
              void (*set_state)(drill_agent_kref_com_epam_drill_agent_State value);
              ...
              struct {
                ...
                drill_agent_kref_com_epam_drill_agent_AgentArguments (*AgentArguments)(drill_agent_KInt seen1, const char* agentId, const char* adminAddress, const char* drillInstallationDir, const char* buildVersion, const char* instanceId, const char* groupId, const char* logLevel, const char* logFile, const char* webAppNames, drill_agent_kref_kotlinx_serialization_SerializationConstructorMarker serializationConstructorMarker);
                drill_agent_kref_com_epam_drill_agent_AgentArguments (*AgentArguments_)(const char* agentId, const char* adminAddress, const char* drillInstallationDir, const char* buildVersion, const char* instanceId, const char* groupId, const char* logLevel, const char* logFile, const char* webAppNames);
                ...
                const char* (*component9)(drill_agent_kref_com_epam_drill_agent_AgentArguments thiz);
                drill_agent_kref_com_epam_drill_agent_AgentArguments (*copy)(drill_agent_kref_com_epam_drill_agent_AgentArguments thiz, const char* agentId, const char* adminAddress, const char* drillInstallationDir, const char* buildVersion, const char* instanceId, const char* groupId, const char* logLevel, const char* logFile, const char* webAppNames);
              ...
              struct {
                drill_agent_KType* (*_type)(void);
                drill_agent_kref_com_epam_drill_agent_State (*State)(drill_agent_KBoolean alive, drill_agent_kref_kotlin_collections_Map webApps, drill_agent_kref_kotlin_collections_List packagePrefixes);
                ...
                drill_agent_KBoolean (*component1)(drill_agent_kref_com_epam_drill_agent_State thiz);
                drill_agent_kref_kotlin_collections_Map (*component2)(drill_agent_kref_com_epam_drill_agent_State thiz);
                drill_agent_kref_kotlin_collections_List (*component3)(drill_agent_kref_com_epam_drill_agent_State thiz);
                drill_agent_kref_com_epam_drill_agent_State (*copy)(drill_agent_kref_com_epam_drill_agent_State thiz, drill_agent_KBoolean alive, drill_agent_kref_kotlin_collections_Map webApps, drill_agent_kref_kotlin_collections_List packagePrefixes);
